...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Rubcoin Core rubcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rubcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rubcoin transaction") + "\n" +
              "  rubcoin-tx [options] -create [commands]   " + _("Create hex-encoded rubcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rubcoin transaction
