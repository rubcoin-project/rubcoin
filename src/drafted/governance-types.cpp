...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RubcoinNetwork") type = RubcoinNetwork;
    if(strType == "RubcoinNetworkVariable") type = RubcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RubcoinNetwork) s = "RubcoinNetwork";
    if(type == RubcoinNetworkVariable) s = "RubcoinNetworkVariable";
