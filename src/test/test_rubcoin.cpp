...
#define BOOST_TEST_MODULE Rubcoin Test Suite

#include "test_rubcoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_rubcoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
