...
public:
    CMainParams() {
        ...
        consensus.nPowTargetSpacing = 1.5 * 60; // Rubcoin: 1.5 minutes
        ...
        consensus.nMinimumChainWork = uint256S("0x0000000000000000000000000000000000000000000000000007d55361c5ca6c"); //FXX
        ...
        */
        ...
        vSeeds.push_back(CDNSSeedData("rub-coin.org", "seed1.rub-coin.org"));
        vSeeds.push_back(CDNSSeedData("rub-coin.org", "seed2.rub-coin.org"));
        vSeeds.push_back(CDNSSeedData("rub-coin.org", "seed3.rub-coin.org"));
        vSeeds.push_back(CDNSSeedData("rub-coin.org", "seed4.rub-coin.org"));

        // Rubcoin addresses start with 'R'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,30);
        // Rubcoin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,13);
        // Rubcoin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,204);
        // Rubcoin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Rubcoin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();

        // Rubcoin BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Rubcoin: 1 day
        consensus.nPowTargetSpacing = 1.5 * 60; // Rubcoin: 90 seconds
        ...
        */
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("rub-coin.org", "testnet1.rub-coin.org"));
        vSeeds.push_back(CDNSSeedData("rub-coin.org", "testnet2.rub-coin.org"));

        // Testnet Rubcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Rubcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Rubcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Rubcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Testnet Rubcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    CRegTestParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Rubcoin: 1 day
        consensus.nPowTargetSpacing = 1.5 * 60; // Rubcoin: 2.5 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        ...
        // Regtest Rubcoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Rubcoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Rubcoin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Regtest Rubcoin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();

        // Regtest Rubcoin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
   }
};
