...
const char * const BITCOIN_CONF_FILENAME = "rubcoin.conf";
const char * const BITCOIN_PID_FILENAME = "rubcoind.pid";
...
bool LogAcceptCategory(const char* category)
{
    if (category != NULL)
    {
        ...
        if (ptrCategory.get() == NULL)
        {
            ...
            // "rubcoin" is a composite category enabling all Rubcoin-related debug output
            if(ptrCategory->count(string("rubcoin"))) {
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/RubcoinCore";
#else
    // Unix
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good()){
        // Create empty rubcoin.conf if it does not excist
    ...
    {
        // Don't overwrite existing settings so command line settings override rubcoin.conf
