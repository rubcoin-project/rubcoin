    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Rubcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rubcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and rubcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Rubcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rubcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rubcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rubcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rubcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a rubcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rubcoin Core help message to get a list with possible Rubcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Rubcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rubcoin network", "", count));
    } else {
...
{
    QString strTitle = tr("Rubcoin Core"); // default title
