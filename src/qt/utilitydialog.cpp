    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Rubcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Rubcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  rubcoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Rubcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 DIN, 0.1 DIN, 1 DIN and 10 DIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://rub-coin.org\">https://rub-coin.org</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Rubcoin Core is shutting down...") + "<br /><br />" +
