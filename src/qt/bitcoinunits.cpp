...
QString BitcoinUnits::description(int unit)
{
    if(Params().NetworkIDString() == CBaseChainParams::MAIN)
    {
        switch(unit)
        {
            case DIN: return QString("Rubcoin");
            case mDIN: return QString("Milli-Rubcoin (1 / 1" THIN_SP_UTF8 "000)");
            case uDIN: return QString("Micro-Rubcoin (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            case dinnies: return QString("Ten Nano-Rubcoin (1 / 100" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
            default: return QString("???");
        }
    }
    else
