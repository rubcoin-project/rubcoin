...
This mechanism has been integrated into Bitcore-Node-Rubcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/rubcoin-project/insight-api-rubcoin#web-socket-api](https://github.com/rubcoin-project/insight-api-rubcoin#web-socket-api)
* API: [https://github.com/rubcoin-project/insight-api-rubcoin#instantsend-transactions](https://github.com/rubcoin-project/insight-api-rubcoin#instantsend-transactions)
...
By default, the Rubcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Rubcoin Core daemon:
