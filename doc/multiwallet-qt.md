...
Only requiring some minor changes is rubcoin.cpp.
...
Changes to rubcoin.cpp
----------------------
rubcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
